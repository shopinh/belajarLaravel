...
<html lang="en">
    <head>
        <title>PiZiStore &mdash; @yield('title')</title>
        <meta charset="utf-8">
                    ...
                    <div class="container">
                        <div class="row align-items-center">
                            ...
                            <div class="col-12 mb-3 mb-md-0 col-md-4 order-1 order-md-2 text-center">
                                <div class="site-logo">
                                    <a href="{{ route('beranda') }}" class="js-logo-clone">PiZiStore</a>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="block-5 mb-5">
                                ...
                                <ul class="list-unstyled">
                                    <li class="address">Universitas Komputer Indonesia, Jln.Dipati Ukur No.112-116, Lebakgede,
                                    Kecamatan Coblong, Kota Bandung.</li>
                                    <li class="phone"><a href="tel://+6212345678910">+62 123 4567 8910</a></li>
                                    <li class="email">devs@pizistore.com</li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-4">
                                <div class="block-5 mb-5">
                                    ...
                                    <p class="text-justify">
                                        PiZiStore adalah sebuah toko yang menjual berbagai macam sepatu untuk
                                        dewasa maupun anak-anak dengan harga murah.
                                    </p>
                                </div>
                            </div>
                    </div>
